...
export const Definitions = {
  ...
  "dialog.swarm.role.fallback": keybind("ctrl+f", "Add fallback model in swarm dialog"),
  "dialog.swarm.role.pop": keybind("ctrl+x", "Remove last fallback in swarm dialog"),
  "dialog.swarm.pool.concurrency": keybind("ctrl+g", "Set worker concurrency in swarm dialog"),
  "dialog.swarm.pool.remove": keybind("ctrl+d", "Remove worker pool entry in swarm dialog"),
